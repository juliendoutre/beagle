...
class TestIndexing:
    def test_document_index(self, shard):
        assert shard.index(InvertedIndexType.DOCUMENTS_INDEX).entries == {
            "0": [1, [0]],
            "1": [1, [0]],
            "2": [2, [0, 1]],
            "3": [2, [1, 3]],
    ...
    def test_frequencies_index(self, shard):
        assert shard.index(InvertedIndexType.FREQUENCIES_INDEX).entries == {
            "0": [1, [(0, 1)]],
            "1": [1, [(0, 1)]],
            "2": [2, [(0, 1), (1, 3)]],
            "3": [2, [(1, 1), (3, 2)]],
    ...
    def test_positions_index(self, shard):
        assert shard.index(InvertedIndexType.POSITIONS_INDEX).entries == {
            "0": [1, [(0, 1, [0])]],
            "1": [1, [(0, 1, [1])]],
            "2": [2, [(0, 1, [2]), (1, 3, [2, 3, 4])]],
            "3": [2, [(1, 1, [0]), (3, 2, [0, 1])]],
